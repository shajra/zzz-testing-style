...
public class TicTacToeGame {
    ...
    public static TicTacToeGame newGame() {
        return new TicTacToeGame();
    }

    public void play(Player player, Position.Horz horz, Position.Vert vert) {
    ...
    private GameState getNextState(Position.Horz horz, Position.Vert vert) {
